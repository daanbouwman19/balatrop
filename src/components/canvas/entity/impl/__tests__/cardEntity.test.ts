...
describe('CardEntity', () => {
    ...
    describe('calculateTypeMultiplier', () => {
        ...
        it('should stack multipliers for multiple target types', () => {
            ...
            const targetTypes = [{ type: { name: 'fire' } }, { type: { name: 'ground' } }];
            const multiplier = cardEntity.calculateTypeMultiplier(targetTypes);
        ...
        it('should handle complex interactions (0.5 * 2 = 1)', () => {
            ...
            const targetTypes = [{ type: { name: 'fire' } }, { type: { name: 'water' } }];
            const multiplier = cardEntity.calculateTypeMultiplier(targetTypes);
        ...
        it('should handle immunity (0 * anything = 0)', () => {
            ...
            const targetTypes = [{ type: { name: 'ground' } }, { type: { name: 'water' } }];
            const multiplier = cardEntity.calculateTypeMultiplier(targetTypes);
        ...
        it('should handle unknown types gracefully', () => {
            ...
            expect(multiplier).toBe(1);
            expect(consoleSpy).toHaveBeenCalledWith('Type "unknown_type" not found in typeRelationsMap.');
